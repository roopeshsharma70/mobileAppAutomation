...
public class SignInPageTest extends TestBase {
	...
	@Test
	public void eBay_Product_Search_Sort_PDP_Watch_Login_Test() throws Exception {
		//Check for Home Page is shown
		ele = HomePage.getEbayLogo(getDriver());
		...
		ele = HomePage.getSearchBox(getDriver());
		if(ele.isDisplayed())
	...
	private void searchKeyword(String keyword) throws Exception {
		...
		ele = SearchPage.getSearchEditBox(getDriver());
		if (ele.isDisplayed())
